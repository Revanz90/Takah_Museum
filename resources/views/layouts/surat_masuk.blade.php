                    ...
                    <tr>
                        ...
                        <td class="project-state text-center">
                            ...
                            <form method="POST" action="{{route('suratditakahkan', ['id'=>$data->id])}}">
                                @csrf
                                <button class="btn-primary btn-xs">Takahkan</button>
                            </form>
                            @endif
                        </td>
                        </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <section class="content">
                    <div class="card">
                        ...
                        <!-- /Navbar Content -->
                        <!-- Page Content -->
                        <form action="" enctype="multipart/form-data" method="POST" class="form-horizontal" id="suratmasukform">
                            {{ csrf_field() }}
                            <div class="card-body">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="" class="col-sm-2 col-form-label font-weight-normal">Perihal
                                                </label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="" class="col-sm-2 col-form-label font-weight-normal">Keterangan
                                                </label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="proposal_ProposalTA" class="col-sm-2 col-form-label font-weight-normal">Upload Surat
                                                    Masuk(.pdf)</label>
                                                <div class="col-sm-10">
                                                    <input type="file" name="Input_SuratMasuk" class="form-control" required>
                                                </div>
                                            </div>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div class="btn-savechange-reset">
                    ...
                    <button type="submit" form="suratmasukform" value="Submit" class="btn btn-primary">Submit</button>
                </div>
            </div>
        </div>
    </div>
